...
TradingView.getIndicator("PUB;EhBrwQPjZ1cE1oo4D8LLRpWDfSgqyNpC").then(async (indic) => {
  ...
  STD.onUpdate(async () => {
    ...
    if (post_order != "none") {
      let check_ta_signal = true;
      if (check_ta_signal) {
        // const ta_signal = await tradingview_ta.get_signal('moving_averages');
